...
struct MealModel: Codable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case id, label, imageUrl, url, source, yield, calories, totalTime, mealType, dietLabels, healthLabels, ingredients, ingredientNames
    ...
    init(id: String, label: String, imageUrl: String, url: String, source: String, yield: Double, calories: Double, mealType: [String]?, dietLabels: [String]?, healthLabels: [String]?, ingredients: [String], ingredientNames: [String], totalTime: Double) {
        self.id = id
        self.label = label
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(ingredientNames, forKey: .ingredientNames)
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        if container.contains(.image) {
            ...
            self.totalTime = try container.decode(Double.self, forKey: .totalTime)
            self.ingredientNames = try container.decode([String].self, forKey: .ingredientNames) 
        }
    }
}
